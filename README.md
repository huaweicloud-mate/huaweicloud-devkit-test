...
5. 每迭代末更新 [templates/dashboard.md](templates/dashboard.md) 质量仪表盘（复制到 metrics/dashboard.md 填写）；缺陷按 [templates/findings.md](templates/findings.md) 记录，全量测完统一合并单提交上游（`scripts/file_issue.py`）
