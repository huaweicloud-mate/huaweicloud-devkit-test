...
| [test-cases/](test-cases/) | 用例体系母版：设计级 123 + 展开级 107 = 230 条（CSV 真源，gen_matrix.py 可复现生成） |
...
| 文件 | 说明 |
|---|---|
| [01-测试规划.md](docs/01-测试规划.md) | **主文档 v1.3**：10 维度 / 230 用例（矩阵 CSV 真源）/ 四级金字塔 / P·G·I 纪律 / 执行分层 |
...
| [测试体系-评审稿.html](docs/测试体系-评审稿.html) | **团队评审用单文件**（固定导航 / 230 用例全量表 / 6 个评审决策点） |
