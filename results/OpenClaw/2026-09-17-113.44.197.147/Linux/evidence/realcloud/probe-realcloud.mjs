// OpenClaw Linux 真云补测探针（2026-09-17）—— 覆盖 D4-13 最小权限、D3-C4 服务矩阵(真机建删归零)、
...
// 核心：①写操作被 IAM 拒绝（权限不足） ②被授予的只读能力可用 ③run-as-readonly env 切换生效
{
  ...
  const probePath = '/home/testbot1/devkit-test/OpenClaw/huaweicloud-devkit-test/results/OpenClaw/2026-09-17-113.44.197.147/Linux/evidence/realcloud/probe-d4-13-switch.mjs';
  const out = execFileSync('python3', ['scripts/run-as-readonly.py', 'node', probePath], { cwd: '/home/testbot1/devkit-test/OpenClaw/huaweicloud-devkit-test', encoding: 'utf8' });
...
console.log('\n=== OpenClaw Linux 真云补测探针结果 (2026-09-17) ===');
