...
// 核心：①写操作被 IAM 拒绝（权限不足） ②被授予的只读能力可用 ③run-as-readonly env 切换生效
{
  ...
  const probePath = '/home/testbot1/devkit-test/OpenClaw/huaweicloud-devkit-test/results/OpenClaw/2026-09-20-113.44.197.147/Linux/evidence/realcloud/probe-d4-13-switch.mjs';
