#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""回填 2026-09-26 OpenClaw Linux 每日测试执行状态（v1.1.7 7456d05，与 09-25 同版）。"""
import csv, os
...
design = {
    ...
    'D1-39': ('NOT_RUN','','【调归属】Windows 专属用例（OS 列标注「专属」：Windows 升级检测链 EINVAL/npm.cmd 专属）；Linux 无 npm.cmd/EINVAL 语义，本 OS 结构性不适用。Linux 侧检测链由源码级 queryDistTagsSync 探针佐证（evidence/d1-upgrade/probe-d1-39-linux.stdout.log dist-tags 含 latest+next）。'),
    ...
    'D9-10': ('PASS','evidence/d9-protocol',''),
    'D9-11': ('PASS','evidence/d9-protocol',''),
    'D9-12': ('FAIL','evidence/d9-protocol',''),
    'D9-13': ('PASS','evidence/d9-protocol',''),
    # D10 评测
