...
const SRC = 'C:/Users/Administrator/devkit-test/testbot5/hdk/plugins/huaweicloud-core/src';
const PLUGIN_ROOT = 'C:/Users/Administrator/devkit-test/testbot5/hdk/plugins/huaweicloud-core';
...
// D4-12: 供应链安装期安全
{
  try {
    ...
    const pkg = JSON.parse(readFileSync('C:/Users/Administrator/devkit-test/testbot5/hdk/package.json', 'utf8'));
