# HISTORY_LINKS — CodeArtsWork/Windows 2026-09-20
...
### #733 [open] [测试报告] huaweicloud-devkit v1.1.5 每日测试缺陷合并单（CodeArtsWork Windows 2026-09-18，6 项已知复现）

- **仓库**: huaweicloud/huaweicloud-devkit
- **状态**: open
- **URL**: https://github.com/huaweicloud/huaweicloud-devkit/issues/733
- **标题**: [测试报告] huaweicloud-devkit v1.1.5 每日测试缺陷合并单（CodeArtsWork Windows 2026-09-18，6 项已知复现）
- **关联用例**: D4-2, D4-3 (已知复现)
- **匹配说明**: 2026-09-18 CodeArtsWork Windows 已报告相同缺陷，本次 2026-09-20 复核仍成立
