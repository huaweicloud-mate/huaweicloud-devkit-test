...
> **生成时间**：2026-09-25 05:06:42（北京时间）
> **执行归档**：`results/WorkBuddy/2026-09-25-188.239.14.150/Windows/`
...
> **执行方法**：源码级探针直调（safety-policy.mjs / update-check.mjs / mcp-protocol.mjs / tools.mjs / risk-rule-engine.mjs）+ MCP 工具枚举 + eval harness 路由层 + 文档/脚本机械验证。14 个聚合探针覆盖 152 个用例 ID，每个用例结果落盘 evidence/<case-id>/stdout.log。
