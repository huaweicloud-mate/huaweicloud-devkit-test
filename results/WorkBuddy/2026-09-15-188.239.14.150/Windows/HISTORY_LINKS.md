...
## D4-15 URL 编码命令绕过安全策略检测
- 今日证据：`evidence/D4-15/stdout.log`，`evidence/D4-15/probe.mjs`
- **关联历史单（已作为缺陷提过，本次为复核）**：
...
## D4-16 Shell 包裹命令绕过安全策略检测
- 今日证据：`evidence/D4-16/stdout.log`，`evidence/D4-16/probe.mjs`
- **关联历史单（已作为缺陷提过，本次为复核）**：
