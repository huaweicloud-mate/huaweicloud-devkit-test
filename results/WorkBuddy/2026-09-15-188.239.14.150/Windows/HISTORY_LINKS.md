...
## D1-39 Windows 升级检测链不可用（npm.cmd spawnSync 缺 shell:true）
...
## D4-2 HW_ACCESS_KEY/HW_SECRET_KEY 环境变量打印未被拦截
...
## D4-16 命令包裹穿透（sh -c/bash -c/eval 包裹 hcloud 写命令不被检测）
...
## D4-6 adminPass 空格分隔 CLI 参数未被脱敏
