/**
 * OpenCode 1.1.4 正式版每日测试探针 - P0/P1/P2 安全核心
 * 覆盖: D4-1, D4-2, D4-3, D4-4, D4-5, D4-6, D4-7, D4-8, D4-9, D4-10, D4-11, D4-12, D4-13, D4-14, D4-15, D4-16, D4-17, D4-18, D4-19, D4-20, D4-21, D4-22, D4-23, D4-24
 */
import { classifyTextCommand, classifyHcloudArgs, redactSecrets, loadPolicy } from 'file:///home/testbot1/devkit-test/testbot1-linux-atomcode/hdk/plugins/huaweicloud-core/src/safety-policy.mjs';
import { loadRiskRules, evaluateCommandRisk, evaluateArtifacts, evaluateDeployPlan } from 'file:///home/testbot1/devkit-test/testbot1-linux-atomcode/hdk/plugins/huaweicloud-core/src/risk-rule-engine.mjs';
...
writeFileSync(new URL('file:///home/testbot1/devkit-test/testbot1-linux-atomcode/huaweicloud-devkit-test/results/AtomCode/2026-09-24-113.44.197.147/Linux/evidence/d4-security/stdout.log'), output, 'utf8');
console.log(output);
