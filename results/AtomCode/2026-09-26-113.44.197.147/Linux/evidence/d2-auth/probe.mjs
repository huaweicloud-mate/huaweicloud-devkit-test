...
writeFileSync(new URL('file:///home/testbot1/devkit-test/testbot1-linux-atomcode/huaweicloud-devkit-test/results/AtomCode/2026-09-26-113.44.197.147/Linux/evidence/d2-auth/stdout.log'), output, 'utf8');
console.log(output);
