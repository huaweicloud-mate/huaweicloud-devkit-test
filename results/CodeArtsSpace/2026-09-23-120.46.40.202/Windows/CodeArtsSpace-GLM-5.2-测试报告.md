...
被测版本从 v1.1.5 升级至 v1.1.7-next.0，D4-2/D4-3 两个历史缺陷已修复（凭证 env 打印与明文 secret API 现均返回 decision:deny）。
...
### 版本对比（vs 2026-09-20 v1.1.5）

| 指标 | v1.1.5 (09-20) | v1.1.7-next.0 (09-23) | 变化 |
|------|----------------|----------------------|------|
| PASS | 135 | 124 | -11 |
| FAIL | 2 | 12 | +10 |
| D4-2 | FAIL | PASS | 已修复 |
| D4-3 | FAIL | PASS | 已修复 |
| D10-3 | PASS | FAIL | 路由准确率断言从严 |
| EXP-E | 15 PASS | 3P/11F/1NR | 路由命中断言从严 |

> 注：D4-2/D4-3 在 v1.1.7-next.0 已修复（safety-policy.mjs 新增凭证 env 打印拦截规则）。D10-3/EXP-E 本轮按用例断言「未命中即判 FAIL」「路由准确率≥90%」从严判定，eval harness 实测路由准确率 21.4%（基线），11 条中文意图 MISS。
