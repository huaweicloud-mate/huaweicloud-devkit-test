#!/usr/bin/env bash
# 每日测试执行 runner — Hermes / Linux / v1.1.5 (fresh 全量重跑 2026-09-20)
set -uo pipefail
...
export EVID_DIR="/home/testbot1/devkit-test/Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-20-113.44.197.147/Linux/evidence"
