...
export HDK_PLUGIN_SRC="/home/zhangshuang/multica_workspaces/092aa561-f81a-4371-a2a4-8988c3df7bc9/01a0cbc6/workdir/hdk/plugins/huaweicloud-core"
export HDK_MCP_SERVER="/home/zhangshuang/multica_workspaces/092aa561-f81a-4371-a2a4-8988c3df7bc9/01a0cbc6/workdir/hdk/plugins/huaweicloud-core/src/mcp-server.mjs"
export EVID_DIR="/home/zhangshuang/multica_workspaces/092aa561-f81a-4371-a2a4-8988c3df7bc9/01a0cbc6/workdir/huaweicloud-devkit-test/results/Hermes/2026-09-23-113.44.143.91/Linux/evidence"
export HDK_REGION="cn-north-4"

cd "$EVID_DIR"
echo "=== SUT ==="; huaweicloud-devkit version 2>&1 | head -2
echo "=== HDK HEAD ==="; git -C /home/zhangshuang/multica_workspaces/092aa561-f81a-4371-a2a4-8988c3df7bc9/01a0cbc6/workdir/hdk log --oneline -1
...
node /home/zhangshuang/multica_workspaces/092aa561-f81a-4371-a2a4-8988c3df7bc9/01a0cbc6/workdir/huaweicloud-devkit-test/eval/harness/run-eval.mjs "$HDK_MCP_SERVER" > eval-harness.txt 2>&1; echo "exit=$?"
