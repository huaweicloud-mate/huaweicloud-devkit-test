...
writeFileSync(new URL('file:///home/testbot3/devkit-test/Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-16-1.94.218.129/Linux/evidence/c4-service-matrix/stdout.log'), output, 'utf8');
console.log(output);
