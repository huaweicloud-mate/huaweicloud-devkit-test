...
writeFileSync(new URL('file:///home/testbot3/devkit-test/Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-16-1.94.218.129/Linux/evidence/mcp-tools/stdout.log'), output, 'utf8');
console.log(output);
