# -*- coding: utf-8 -*-
"""Hermes Linux 2026-09-20 每日测试：证据分发 + 回填三 CSV（v1.1.5）。"""
...
PASS_D = {
    ...
    "D8-7":"evidence/D8-7","D8-9":"evidence/D8-9","D8-10":"evidence/D8-10",
...
BLOCKED_D = {
    ...
    "D9-9":"【改用例】tools/call 超时协议语义需可注入延迟夹具(30s 挂起)；capabilities.cancellation 探针确认 false",
    "D3-S3":"【补环境】沙箱 deploy_nginx 返回 ok=true 但 deploy_check nginx_serving/devbridge_tunnel FAIL、无公网 URL（DevStation 隧道外发环境依赖）；connect/upload(md5)/deploy/close 链路已真实执行",
}
