#!/usr/bin/env bash
# Hermes Linux 2026-09-16 每日测试 —— 全量重跑（v1.1.5）
set -u
...
ISO_HOME="$HOME/devkit-test/Hermes/iso-home-20260916"
...
cat /home/testbot2/devkit-test/Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-16-124.70.78.131/Linux/evidence/_baseline/version.log 2>/dev/null || echo "v1.1.5" > /tmp/_bl.txt
...
echo "===== [21] D10 评测集 harness (EXP-E01~E15) ====="
node "$EVAL" "$MCP" > eval-harness.log 2>&1; echo "exit=$?"
