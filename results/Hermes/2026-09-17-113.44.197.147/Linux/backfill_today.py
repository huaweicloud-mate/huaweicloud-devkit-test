#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""今日(2026-09-17)每日测试回填：证据落盘 + CSV 执行状态回填。
基于本日 fresh 探针实测结果（reverify-2026-09-17.sh + D10 run-eval + D4-13/D4-14 真云）。
"""
import os, csv, json, datetime, shutil

REPO = os.path.expanduser('~/devkit-test/Hermes/huaweicloud-devkit-test')
PKG = os.path.join(REPO, 'results', 'Hermes', '2026-09-17-113.44.197.147', 'Linux')
