# -*- coding: utf-8 -*-
"""Hermes Linux 2026-09-14 每日回归：证据分发——把主探针日志按 CASE 段切分到 evidence/<case-id>/。

读取 _probes/ 下的主日志，按 `=====CASE <id>=====` / `=====END <id>=====` 切段，
写入 evidence/<case-id>/stdout.log，并复制对应探针源为 probe 文件。
D1 安装探针无 CASE 标记，按 STEP 手工切片。
"""
import os, re, shutil
