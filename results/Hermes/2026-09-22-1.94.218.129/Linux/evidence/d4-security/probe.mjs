 ...
 */
import { classifyTextCommand, classifyHcloudArgs, redactSecrets, loadPolicy } from 'file:///home/testbot3/devkit-test/Hermes/hdk/plugins/huaweicloud-core/src/safety-policy.mjs';
import { loadRiskRules, evaluateCommandRisk, evaluateArtifacts, evaluateDeployPlan } from 'file:///home/testbot3/devkit-test/Hermes/hdk/plugins/huaweicloud-core/src/risk-rule-engine.mjs';
...
writeFileSync(new URL('file:///home/testbot3/devkit-test/Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-22-1.94.218.129/Linux/evidence/d4-security/stdout.log'), output, 'utf8');
console.log(output);
