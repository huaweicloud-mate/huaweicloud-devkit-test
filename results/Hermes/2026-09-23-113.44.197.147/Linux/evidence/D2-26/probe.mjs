...
const SRC = join(process.env.HUAWEICLOUD_HOME || '/home/testbot1/devkit-test/Hermes/hdk/plugins/huaweicloud-core', 'src');
// credentials.mjs 真实路径固定（源码 import，不受 HUAWEICLOUD_HOME 影响）:
const REAL_SRC = '/home/testbot1/devkit-test/Hermes/hdk/plugins/huaweicloud-core/src';
