#!/usr/bin/env bash
# 真云 E2E 执行 runner — Hermes / Linux / 2026-09-24 (fresh 全量真机执行)
set -uo pipefail
...
export EVID_DIR="/home/testbot1/devkit-test/Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-25-113.44.197.147/Linux/evidence"
...
# D3-S1 / D3-C13 / D3-S4 (realcloud-newcases.mjs; D3-S2 内部用 --name 过滤有缺陷, 下方 D3-S2/probe.mjs 覆盖)
