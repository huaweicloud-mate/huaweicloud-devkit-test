...
- **证据**：`evidence/D4-23/stdout.log` + `evidence/D4-23/probe.mjs`（源码零引用 + 隔离安装产物无 .mdc）
...
- **证据**：`evidence/D9-9/stdout.log`（extended-probe）
...
- **证据**：`evidence/D8-9/stdout.log`（new-config-probe）
