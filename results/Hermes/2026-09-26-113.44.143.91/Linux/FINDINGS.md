...
> **落盘路径**：`results/Hermes/2026-09-26-113.44.143.91/Linux/FINDINGS.md`
> **生成时间**：2026-09-26 05:20（北京时间）
> **被测版本**：huaweicloud-devkit v1.1.7（npm latest，gitHead `7456d05`，PR #813）
> **执行方式**：2026-09-26 源码级探针 22 支 fresh 重跑（v1.1.7）+ `eval/harness/run-eval.mjs` 中文意图路由 + `eval/harness/protocol-probe.mjs` 协议层 + 真云 E2E（D3-S1/S2/S3/S4/C13/S6 建删归零、D4-13 只读子账号、D4-14 VPC+CTS 审计归零）
