...
writeFileSync(new URL('file:///home/zhangshuang/devkit-test/Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-17-113.44.143.91/Linux/evidence/mcp-tools/stdout.log'), output, 'utf8');
console.log(output);
