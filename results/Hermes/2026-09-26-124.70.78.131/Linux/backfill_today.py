# -*- coding: utf-8 -*-
"""Hermes Linux 2026-09-26 每日测试：证据分发（stdout.txt）+ 回填三 CSV（v1.1.7 正式版 gitHead 7456d05）。"""
...
print("== D4-21 hcl 补充 ==")
with open(os.path.join(EVID, "D4-21", "stdout.txt"), "a", encoding="utf-8") as f:
    f.write("\n===== hcl-probe 补充 =====\n" + read("hcl-probe.log"))
...
write_case("_baseline", "huaweicloud-devkit v1.1.7\ngitHead 7456d05\n", None)
print("  _baseline: v1.1.7 (gitHead 7456d05)")
...
PASS_D = {
    ...
    "D4-27":"evidence/D4-27","D4-28":"evidence/D4-28","D4-29":"evidence/D4-29",
...
FAIL_D = {
    ...
    "D4-25":("evidence/D4-25",""),
    "D4-26":("evidence/D4-26",""),
    "D3-S5":("evidence/D3-S5",""),
    "D3-S6":("evidence/D3-S6",""),
    "D3-S7":("evidence/D3-S7",""),
    "D9-12":("evidence/D9-12",""),
...
BLOCKED_D = {
    ...
    "D3-S3":"【补环境】沙箱 connect/upload(md5)/deploy/close 全链路真实执行通过，但 deploy_nginx 返回 url 为空、deploy_check 的 devbridge_tunnel FAIL（DevStation 公网隧道/预览外发环境缺依赖）",
}
