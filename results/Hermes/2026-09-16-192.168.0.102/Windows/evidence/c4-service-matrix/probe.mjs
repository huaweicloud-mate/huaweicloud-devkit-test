 ...
 */
import { callTool } from 'file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/hdk/plugins/huaweicloud-core/src/tools.mjs';
...
writeFileSync(new URL('file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-16-192.168.0.102/Windows/evidence/c4-service-matrix/stdout.log'), output, 'utf8');
console.log(output);
