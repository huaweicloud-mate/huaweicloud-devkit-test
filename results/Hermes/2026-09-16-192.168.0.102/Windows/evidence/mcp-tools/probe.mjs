...
writeFileSync(new URL('file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-16-192.168.0.102/Windows/evidence/mcp-tools/stdout.log'), output, 'utf8');
console.log(output);
