 ...
 */
import { classifyTextCommand, classifyHcloudArgs, redactSecrets, loadPolicy } from 'file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/hdk/plugins/huaweicloud-core/src/safety-policy.mjs';
import { loadRiskRules, evaluateCommandRisk, evaluateArtifacts, evaluateDeployPlan } from 'file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/hdk/plugins/huaweicloud-core/src/risk-rule-engine.mjs';
...
writeFileSync(new URL('file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-16-192.168.0.102/Windows/evidence/d4-security/stdout.log'), output, 'utf8');
console.log(output);
