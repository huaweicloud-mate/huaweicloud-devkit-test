 ...
 */
import { globalCredentialsPath, readGlobalCredentials, resolveCredentials, setConfiguredBySession, hasRuntimeCredentials, setRuntimeCredentials, clearRuntimeCredentials, isPlaceholder, writeGlobalCredentials } from 'file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/hdk/plugins/huaweicloud-core/src/auth/credentials.mjs';
import { TOOL_DEFINITIONS, callTool } from 'file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/hdk/plugins/huaweicloud-core/src/tools.mjs';
import { classifyTextCommand, classifyHcloudArgs, redactSecrets } from 'file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/hdk/plugins/huaweicloud-core/src/safety-policy.mjs';
import { readFileSync, existsSync, readdirSync } from 'node:fs';
import { join } from 'node:path';
import { writeFileSync } from 'node:fs';

const pkgRoot = 'C:/Users/Administrator/devkit-test/testbot3-Hermes/hdk';
const results = [];
...
let dfMod; try { dfMod = await import('file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/hdk/plugins/huaweicloud-core/src/detect-framework.mjs'); } catch { dfMod = null; }
...
writeFileSync(new URL('file:///C:/Users/Administrator/devkit-test/testbot3-Hermes/huaweicloud-devkit-test/results/Hermes/2026-09-16-192.168.0.102/Windows/evidence/d2-auth/stdout.log'), output, 'utf8');
console.log(output);
