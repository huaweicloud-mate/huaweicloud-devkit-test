 ...
 */
import { globalCredentialsPath, readGlobalCredentials, resolveCredentials, setConfiguredBySession, hasRuntimeCredentials, setRuntimeCredentials, clearRuntimeCredentials, isPlaceholder, writeGlobalCredentials } from 'file:///C:/Users/Administrator/devkit-test/hermes/hdk/plugins/huaweicloud-core/src/auth/credentials.mjs';
import { TOOL_DEFINITIONS, callTool } from 'file:///C:/Users/Administrator/devkit-test/hermes/hdk/plugins/huaweicloud-core/src/tools.mjs';
import { classifyTextCommand, classifyHcloudArgs, redactSecrets } from 'file:///C:/Users/Administrator/devkit-test/hermes/hdk/plugins/huaweicloud-core/src/safety-policy.mjs';
...
let dfMod; try { dfMod = await import('file:///C:/Users/Administrator/devkit-test/hermes/hdk/plugins/huaweicloud-core/src/detect-framework.mjs'); } catch { dfMod = null; }
