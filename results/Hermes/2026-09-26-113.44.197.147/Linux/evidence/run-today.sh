...
echo; echo "====== D9-12 initialize 握手 (P0) ======"
node probe-d9-12.mjs > d9-12-run.log 2>&1; echo "exit=$?"

echo; echo "====== D9-13 tools/call 凭证不泄露 (P0) ======"
node probe-d9-13.mjs > d9-13-run.log 2>&1; echo "exit=$?"

echo; echo "====== D4-28 + D1-67 + D1-69 (hookchain-cli) ======"
