...
- **证据**：`evidence/final-suite-20260914.log`；源码测试 `test/agent-install.test.mjs:573-735`。
- **状态**：已提单 #670（与 #654 重复）
...
- **证据**：`evidence/final-suite-20260914.log`；源码测试 `test/upgrade-session.test.mjs:134-140`。
- **状态**：已提单 #670（与 #654 重复）
