...
writeFileSync(new URL('file:///C:/Users/Administrator/devkit-test/huaweicloud-devkit-test/results/Codex/2026-09-17-192.168.0.102/Windows/evidence/d1-upgrade/stdout.log'), output, 'utf8');
console.log(output);
