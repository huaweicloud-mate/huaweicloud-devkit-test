...
writeFileSync(new URL('file:///C:/Users/Administrator/devkit-test/OpenCode/huaweicloud-devkit-test/results/OpenCode/2026-09-15-188.239.14.150/Windows/evidence/d1-upgrade/stdout.log'), output, 'utf8');
console.log(output);
