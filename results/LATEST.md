...
> - **回归验证 #519/#542/#544（1.1.2-next.4）全过**：PR #545 修复全部在发布线（91536d7 已并入 608b120）——Codex 插件名/failure 非零退出/marker 隔离/hcloud-probe 5 分类实测/S1-S2 指纹误报 3 场景隔离验证/hook Node 化；**副作用识别无引入问题**（规则引擎零改动、工具零删减 39=37+#525 新增、#545 相关 T1 87/87 全过；全量失败=mcp-server 偶发超时环境项）。详见 results/ITER-003-2026-09-09/回归验证-519-542-544.md
