...
> **说明**：本轮 10 项缺陷中 9 项为 v1.1.4-next.6 已提单缺陷在 v1.1.4 正式版未修复的复现，#3（kms DecryptData）为本轮新确认。
...
## #3【P0】明文 secret API 拦截漏 kms DecryptData
...
## #4【P0】hook 命令替换绕过（$(...) + ANSI-C quoting）
...
## #6【P0】全局规则 huawei-agent-rules 未随安装注入
...
## #7【P1】hook 畸形输入 fail-open（应 fail-closed）
...
## #8【P1】JSON-RPC 错误码契约漂移（未返回 -32601）
...
## #10【P2】文档与能力漂移（AGENTS.md 39 vs 实现 40 工具）
